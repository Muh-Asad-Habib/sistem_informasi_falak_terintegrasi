...
export function Badge({ children, className = '', variant = 'default', ...props }: BadgeProps) {
  ...
  const variants = {
    ...
    gold: 'bg-sifa-gold-50 text-sifa-gold-900 border-sifa-gold-100 dark:bg-sifa-gold-900/20 dark:text-sifa-gold-600 dark:border-sifa-gold-900/30',
    blue: 'bg-sifa-blue-100/50 text-sifa-blue-900 border-sifa-blue-100 dark:bg-sifa-blue-900/20 dark:text-sifa-blue-700 dark:border-sifa-blue-900/30',
  };
