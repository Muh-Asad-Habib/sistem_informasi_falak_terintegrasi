...
export const PARAMETER_METODE: Record<HisabMetode, ParameterHisab> = {
  Muhammadiyah: {
    ...
    hIsya: -18,
    sumber:
      'Keputusan Munas Tarjih XXXI (ditanfidz SK PP Muhammadiyah, 2021) tentang kriteria awal waktu Subuh h = -18° & Pedoman Hisab Muhammadiyah (Majelis Tarjih dan Tajdid)',
    statusRujukan: 'terverifikasi',
    catatan:
      'Munas Tarjih XXXI merevisi ketinggian matahari awal Subuh dari -20° menjadi -18°. Contoh hisab Modul AIK IV Bab III masih memakai -20° (nilai lama); SIFA mengikuti ketetapan resmi terbaru.',
  },
  Kemenag: {
    ...DASAR_ASTRONOMIS,
    label: 'Kemenag RI',
    ...
    statusRujukan: 'terverifikasi',
    catatan:
      'Kemenag RI tetap memakai -20°/-18° sesuai Almanak Hisab Rukyat (sama dengan contoh Modul AIK IV). Sejak Munas Tarjih XXXI, Subuh Muhammadiyah (-18°) lebih siang daripada Kemenag; SIFA menampilkannya apa adanya.',
  },
  MABIMS: {
    ...DASAR_ASTRONOMIS,
    label: 'MABIMS',
  ...
  NU: {
    ...
    statusRujukan: 'perlu_konfirmasi',
    catatan:
      'TODO: perlu konfirmasi rujukan cetak LF PBNU. Sepanjang penelusuran, LF PBNU memakai ketinggian matahari yang sama dengan Kemenag (-20°/-18°) dan mazhab Asar Syafi’i. ' +
      CATATAN_DHUHA_IMSAK,
  },
  MWL: {
    ...DASAR_ASTRONOMIS,
